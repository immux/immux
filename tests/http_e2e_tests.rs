...
mod http_e2e_tests {
    ...
    use immuxsys_dev_utils::dev_utils::{
        csv_to_json_table, e2e_verify_correctness, launch_db_server, notified_sleep, UnitList,
    };

    #[test]
    fn http_e2e_grouping_get_set() {
        let port = 20030;
        thread::spawn(move || launch_db_server("http_e2e_grouping_get_set", Some(port), None));
        notified_sleep(5);
    ...
    fn e2e_real_data_get_set() {
        let port = 20022;
        thread::spawn(move || launch_db_server("e2e_real_data_get_set", Some(port), None));
        notified_sleep(5);
    ...
    fn e2e_single_unit_get_set() {
        let port = 10083;
        thread::spawn(move || launch_db_server("e2e_single_unit_get_set", Some(port), None));
        notified_sleep(5);
    ...
    fn e2e_revert_one() {
        let port = 10084;
        thread::spawn(move || launch_db_server("e2e_revert_one", Some(port), None));
        notified_sleep(5);
    ...
    fn e2e_remove_one() {
        let port = 10085;
        thread::spawn(move || launch_db_server("e2e_remove_one", Some(port), None));
        notified_sleep(5);
    ...
    fn e2e_revert_all() {
        let port = 10086;
        thread::spawn(move || launch_db_server("e2e_revert_all", Some(port), None));
        notified_sleep(5);
    ...
    fn e2e_remove_all() {
        let port = 10087;
        thread::spawn(move || launch_db_server("e2e_remove_all", Some(port), None));
        notified_sleep(5);
    ...
    fn e2e_atomicity_commit() {
        let port = 10088;
        thread::spawn(move || launch_db_server("e2e_atomicity_commit", Some(port), None));
        notified_sleep(5);
    ...
    fn e2e_atomicity_abort() {
        let port = 10089;
        thread::spawn(move || launch_db_server("e2e_atomicity_abort", Some(port), None));
        notified_sleep(5);
    ...
    fn e2e_set_isolation() {
        let port = 10090;
        thread::spawn(move || launch_db_server("e2e_set_isolation", Some(port), None));
        notified_sleep(5);
    ...
    fn e2e_remove_one_isolation() {
        let port = 10091;
        thread::spawn(move || launch_db_server("e2e_remove_one_isolation", Some(port), None));
        notified_sleep(5);
    ...
    fn e2e_revert_one_isolation() {
        let port = 10092;
        thread::spawn(move || launch_db_server("e2e_revert_one_isolation", Some(port), None));
        notified_sleep(5);
    ...
    fn e2e_remove_all_isolation() {
        let port = 10093;
        thread::spawn(move || launch_db_server("e2e_remove_all_isolation", Some(port), None));
        notified_sleep(5);
    ...
    fn e2e_revert_all_isolation() {
        let port = 10094;
        thread::spawn(move || launch_db_server("e2e_revert_all_isolation", Some(port), None));
        notified_sleep(5);
    ...
    fn e2e_transaction_not_alive_after_revert_all() {
        ...
        thread::spawn(move || {
            launch_db_server(
                "e2e_transaction_not_alive_after_revert_all",
                Some(port),
                None,
            )
        });
    ...
    fn e2e_unexpected_commit_transaction_id() {
        let port = 10096;
        thread::spawn(move || {
            launch_db_server("e2e_unexpected_commit_transaction_id", Some(port), None)
        });
        notified_sleep(5);
    ...
    fn e2e_unexpected_abort_transaction_id() {
        let port = 10097;
        thread::spawn(move || {
            launch_db_server("e2e_unexpected_abort_transaction_id", Some(port), None)
        });
        notified_sleep(5);
    ...
    fn e2e_last_one_commit_wins() {
        let port = 10098;
        thread::spawn(move || launch_db_server("e2e_last_one_commit_wins", Some(port), None));
        notified_sleep(5);
    ...
    fn e2e_read_inside_transaction() {
        let port = 10099;
        thread::spawn(move || launch_db_server("e2e_read_inside_transaction", Some(port), None));
        notified_sleep(5);
    ...
    fn e2e_dirty_read() {
        let port = 10100;
        thread::spawn(move || launch_db_server("e2e_dirty_read", Some(port), None));
        notified_sleep(5);
    ...
    fn e2e_filter_read() {
        ...
        let port = 10011;
        thread::spawn(move || launch_db_server("e2e_filter_read", Some(port), None));
        notified_sleep(5);
